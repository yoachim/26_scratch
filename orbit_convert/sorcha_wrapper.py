...
def sorcha_wrapper(pointing_database, orbin_file,
                   colors_file,
                   stats_out_file="",
                   ephemerides_type="ar",
                   observing_filters="r,g,i,z,u,y"):

    """Try running sorcha without configuration files.
    ...
    sorcha_args = sorchaArguments(cmd_args_dict={"paramsinput": colors_file,
